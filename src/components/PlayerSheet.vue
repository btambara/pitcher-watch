...
<template>
    <v-container class="d-flex align-center justify-center">
        <v-sheet width="90%" color="rgb(0, 0, 0, 0.0)">
            <v-row>
                <v-col>
                    <PlayerDetails class="ma-4" full-name="Clayton Kershaw" primary-number="22" primary-position="P" :logo="DodgerLogo"/>
                </v-col>
                ...
                <v-col>
                    <v-card class="ml-4 mr-4 mb-4" rounded="lg">
                        ...
                        <v-window v-model="tab">
                            ...
                            <v-window-item :key=2>
                                <v-virtual-scroll height="400" :items="pitchers[0].pitchingTypes">
